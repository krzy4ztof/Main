...
public class DraggedSegments extends CopyPasteSegments {
	...
	/*
	 * public DraggedSegments(MapPane mapPane, CopyPasteSegments
	 * selectedSegments, Point firstDragPoint, Point lastDragPoint, int i) {
	 * 
	 * int vectorX = lastDragPoint.x - firstDragPoint.x; int vectorY =
	 * lastDragPoint.y - firstDragPoint.y;
	 * 
	 * Point minDraggedPoint = new Point(selectedSegments.getMinPoint().x +
	 * vectorX, selectedSegments.getMinPoint().y + vectorY); Point
	 * maxDraggedPoint = new Point(selectedSegments.getMaxPoint().x + vectorX,
	 * selectedSegments.getMaxPoint().y + vectorY);
	 * 
	 * minPoint = findMinPoint(minDraggedPoint, maxDraggedPoint); maxPoint =
	 * findMaxPoint(minDraggedPoint, maxDraggedPoint);
	 * 
