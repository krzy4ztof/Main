...
public class MapLoader {
     ...
     * @throws Exception
     */
    public MapApi loadMapFromFile(File rFile, MapThemesList mapThemesList) throws Exception {
    ...
    private void processEvent(XMLEvent xmlEvent, MapApi mapApi,
        ...
        if (xmlEvent.isStartElement()) {
            ...
            if (elementName.equals(MapFileDefinitions.MAP_XML_ELEMENT)) {
            ...
            } else if (elementName.equals(MapFileDefinitions.GENERAL_PARAMETERS_ELEMENT)) {
            ...
            } else if (elementName.equals(MapFileDefinitions.SEGMENTS_CODE_ELEMENT)) {
                ...
                this.readRowElement(startElement, mapApi, segmentsCode, mapThemesList);
            }
     ...
     * @throws mapEditor.MapLoader.InvalidXML
     */
    private void readSizeElement(StartElement startElement, MapApi mapApi) throws InvalidXML {
        ...
        atrCols = startElement.getAttributeByName(new QName(MapFileDefinitions.COLUMNS_ATTRIBUTE));
        ...
        atrRows = startElement.getAttributeByName(new QName(MapFileDefinitions.ROWS_ATTRIBUTE));
     ...
     * @throws mapEditor.MapLoader.InvalidXML
     */
    private void readCodeElement(StartElement startElement, Hashtable<String, String> segmentsCode) throws InvalidXML {
        if (this.processingSegmentsCode != ProcessingElement.in) {
            throw new InvalidXML();
        }
        ...
        atrId = startElement.getAttributeByName(new QName(MapFileDefinitions.ID_ATTRIBUTE));
        ...
        atrImage = startElement.getAttributeByName(new QName(MapFileDefinitions.IMAGE_ATTRIBUTE));
    ...
    private void readRowElement(StartElement startElement, MapApi mapApi,
        ...
        int rowNumber = -1;
        atr = startElement.getAttributeByName(new QName(MapFileDefinitions.NUMBER_ATTRIBUTE));
        ...
        atr = startElement.getAttributeByName(new QName(MapFileDefinitions.SEGMENTS_ATTRIBUTE));
