...
public class MapResizePanel extends JDialog implements ActionListener {
    ...
    public MapResizePanel(Config configParam, ResourceBundle resourceBundle,
            JFrame jFrameParam) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (action.equals("BTN_OK")) {
            ...
            selectedCol = config.getMapApiDefaultColumnsNumber();
            selectedRow = config.getMapApiDefaultRowsNumber();
