...
public class GraphicsSystem implements ActionListener {
    ...
    public GraphicsSystem(ResourceBundle resourceBundle,
        ...
        mapApi = new MapApi(MapApi.DEFAULT_COLUMNS_NUMBER, MapApi.DEFAULT_ROWS_NUMBER);
    ...
    private void newMapAction() {
        ...
        MapResizePanel MRP = new MapResizePanel(messages, jFrame);
