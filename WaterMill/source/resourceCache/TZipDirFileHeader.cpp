...
/*
 ...
 ofs << reinterpret_cast<unsigned long>(zipDirFileHeader.sig) << endl
 << endl;
 ...
 ofs << "%S%" << std::hex << "SIG: " << zipDirFileHeader.sig << endl

 << "ISCOMPRESSION: " << zipDirFileHeader.isCompression << endl

 << "VERMADE: " << zipDirFileHeader.verMade << endl

 << "VERNEEDED: " << zipDirFileHeader.verNeeded << endl

 << "FLAG: " << zipDirFileHeader.flag << endl

 << "COMPRESSION: " << zipDirFileHeader.compression << endl
 << zipDirFileHeader.modTime << endl << zipDirFileHeader.modDate
 << endl << zipDirFileHeader.crc32 << endl
 << zipDirFileHeader.cSize << endl << zipDirFileHeader.ucSize
 << endl << zipDirFileHeader.fnameLen << endl
 << zipDirFileHeader.xtraLen << endl << zipDirFileHeader.cmntLen
 << endl << zipDirFileHeader.diskStart << endl
 << zipDirFileHeader.intAttr << endl << zipDirFileHeader.extAttr
 << endl << zipDirFileHeader.hdrOffset << endl << std::dec
 << "%E%";
 }
 ...
 ss << reinterpret_cast<unsigned long>(zipDirFileHeader.sig) << endl
 << endl;
 ...
 ss << std::hex << "SIG: " << zipDirFileHeader.sig << endl
 << "ISCOMPRESSION: " << zipDirFileHeader.isCompression << endl
 << "VERMADE: " << zipDirFileHeader.verMade << endl
 << "VERNEEDED: " << zipDirFileHeader.verNeeded << endl
 << "FLAG: " << zipDirFileHeader.flag << endl << "COMPRESSION: "
 << zipDirFileHeader.compression << endl << "MODTIME: "
 << zipDirFileHeader.modTime << endl << "MODDATE: "
 << zipDirFileHeader.modDate << endl << "CRC32: "
 << zipDirFileHeader.crc32 << endl << "CSIZE: "
 << zipDirFileHeader.cSize << endl << "UCSIZE: "
 << zipDirFileHeader.ucSize << endl << "FNAMELEN: "
 << zipDirFileHeader.fnameLen << endl << "XTRALEN: "
 << zipDirFileHeader.xtraLen << endl << "CMNTLEN: "
 << zipDirFileHeader.cmntLen << endl << "DISKSTART: "
 << zipDirFileHeader.diskStart << endl << "INTATTR: "
 << zipDirFileHeader.intAttr << endl << "EXTATTR: "
 << zipDirFileHeader.extAttr << endl << "HROFFSET: "
 << zipDirFileHeader.hdrOffset << endl << std::dec;
