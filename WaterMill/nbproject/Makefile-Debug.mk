...
${OBJECTDIR}/source/gameInitialization/linux/LinuxCalls.o: source/gameInitialization/linux/LinuxCalls.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/boost_1_60_0 -I../../libraries/glut-3.7.6-bin -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/linux/LinuxCalls.o source/gameInitialization/linux/LinuxCalls.cpp
...
${OBJECTDIR}/source/gameInitialization/windows/Cygwin64Calls.o: source/gameInitialization/windows/Cygwin64Calls.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/boost_1_60_0 -I../../libraries/glut-3.7.6-bin -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/windows/Cygwin64Calls.o source/gameInitialization/windows/Cygwin64Calls.cpp

${OBJECTDIR}/source/gameInitialization/windows/Windows32Calls.o: source/gameInitialization/windows/Windows32Calls.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization/windows
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/boost_1_60_0 -I../../libraries/glut-3.7.6-bin -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/windows/Windows32Calls.o source/gameInitialization/windows/Windows32Calls.cpp

${OBJECTDIR}/source/gameInitialization/windows/Windows64Calls.o: source/gameInitialization/windows/Windows64Calls.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization/windows
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/boost_1_60_0 -I../../libraries/glut-3.7.6-bin -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/windows/Windows64Calls.o source/gameInitialization/windows/Windows64Calls.cpp
