...
${OBJECTDIR}/source/gameInitialization/AudioSystem.o: source/gameInitialization/AudioSystem.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/AudioSystem.o source/gameInitialization/AudioSystem.cpp

${OBJECTDIR}/source/gameInitialization/DataFiles.o: source/gameInitialization/DataFiles.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/DataFiles.o source/gameInitialization/DataFiles.cpp

${OBJECTDIR}/source/gameInitialization/ErrorCode.o: source/gameInitialization/ErrorCode.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/ErrorCode.o source/gameInitialization/ErrorCode.cpp

${OBJECTDIR}/source/gameInitialization/GameCodeApp.o: source/gameInitialization/GameCodeApp.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/GameCodeApp.o source/gameInitialization/GameCodeApp.cpp

${OBJECTDIR}/source/gameInitialization/VideoSystem.o: source/gameInitialization/VideoSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/VideoSystem.o source/gameInitialization/VideoSystem.cpp
...
${OBJECTDIR}/source/gameInitialization/linux/LinuxCalls.o: source/gameInitialization/linux/LinuxCalls.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/linux/LinuxCalls.o source/gameInitialization/linux/LinuxCalls.cpp
...
${OBJECTDIR}/source/gameInitialization/windows/Cygwin64Calls.o: source/gameInitialization/windows/Cygwin64Calls.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/windows/Cygwin64Calls.o source/gameInitialization/windows/Cygwin64Calls.cpp

${OBJECTDIR}/source/gameInitialization/windows/Windows32Calls.o: source/gameInitialization/windows/Windows32Calls.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization/windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/windows/Windows32Calls.o source/gameInitialization/windows/Windows32Calls.cpp

${OBJECTDIR}/source/gameInitialization/windows/Windows64Calls.o: source/gameInitialization/windows/Windows64Calls.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/gameInitialization/windows
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/gameInitialization/windows/Windows64Calls.o source/gameInitialization/windows/Windows64Calls.cpp

${OBJECTDIR}/source/main/Main.o: source/main/Main.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/main
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/main/Main.o source/main/Main.cpp

${OBJECTDIR}/source/testClasses/TestClass.o: source/testClasses/TestClass.cpp 
	${MKDIR} -p ${OBJECTDIR}/source/testClasses
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/testClasses/TestClass.o source/testClasses/TestClass.cpp
